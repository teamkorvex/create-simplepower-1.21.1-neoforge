...
import com.seagullsz.createsimplepower.content.kinetics.CreateSimplePowerGeneratorBlock;
import com.seagullsz.createsimplepower.content.kinetics.CreateSimplePowerKineticBlock;
...
public class AllBlocks {
     ...
     */
    public static final BlockEntry<CreateSimplePowerKineticBlock> EXAMPLE_KINETIC_BLOCK = CreateSimplePower.REGISTRATE
            .block("createsimplepower_kinetic_block", CreateSimplePowerKineticBlock::new)
     ...
     * registered in CreateSimplePower. The transform call attaches the EXAMPLE_SOURCE display
     * source to this block.
     */
    public static final BlockEntry<CreateSimplePowerGeneratorBlock> EXAMPLE_GENERATOR_BLOCK = CreateSimplePower.REGISTRATE
            .block("createsimplepower_generator_block", CreateSimplePowerGeneratorBlock::new)
     ...
     * axis so the shaft rendered by CreateSimplePowerShaftRenderer visibly pokes out of both ends.
