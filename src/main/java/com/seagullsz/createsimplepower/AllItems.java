 ...
 * or remove the override and add assets/createsimplepower/textures/item/name.png.
 */
public class AllItems {

    public static final ItemEntry<Item> EXAMPLE_ITEM = CreateSimplePower.REGISTRATE
            .item("createsimplepower_item", Item::new)
     ...
     */
    public static final ItemEntry<Item> EXAMPLE_RESULT = CreateSimplePower.REGISTRATE
            .item("createsimplepower_result", Item::new)
     ...
     */
    public static final ItemEntry<Item> INCOMPLETE_EXAMPLE = CreateSimplePower.REGISTRATE
