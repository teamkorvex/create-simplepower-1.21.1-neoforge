 ...
 */
public class CreateSimplePowerShaftRenderer<T extends KineticBlockEntity> extends KineticBlockEntityRenderer<T> {

    public CreateSimplePowerShaftRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
