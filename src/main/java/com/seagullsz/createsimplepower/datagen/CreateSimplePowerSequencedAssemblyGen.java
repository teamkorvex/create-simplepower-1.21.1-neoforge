 ...
 */
public class CreateSimplePowerSequencedAssemblyGen extends SequencedAssemblyRecipeGen {

    GeneratedRecipe EXAMPLE = create("createsimplepower_result", b -> b
    ...
    public CreateSimplePowerSequencedAssemblyGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
