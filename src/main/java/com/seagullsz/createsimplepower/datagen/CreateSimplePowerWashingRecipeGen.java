 ...
 */
public class CreateSimplePowerWashingRecipeGen extends WashingRecipeGen {

    GeneratedRecipe EXAMPLE = create("createsimplepower_washing",
            b -> b.require(Items.DIRT).output(AllItems.EXAMPLE_ITEM.get()));

    public CreateSimplePowerWashingRecipeGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
